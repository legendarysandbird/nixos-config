...
keys = [
    ...
    Key([mod, "control"], left_key, lazy.layout.grow_left(), desc="Grow window to the left"),
    Key([mod, "control"], right_key, lazy.layout.grow_right(), desc="Grow window to the right"),
    Key([mod, "control"], down_key, lazy.layout.grow_down(), desc="Grow window down"),
    Key([mod, "control"], up_key, lazy.layout.grow_up(), desc="Grow window up"),
